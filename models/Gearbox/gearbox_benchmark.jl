...
model = "Gear"
cases = ["GRBX01-MES01", "GRBX01-MES01-discrete",
         "GRBX02-MES01", "GRBX02-MES01-discrete"]
...
SUITE[model][case] = @benchmarkable solve($prob_GRBX01, max_jumps=100,
                   clustering_method=LazyClustering(1, convex=false),
                   intersect_source_invariant=true,
                   intersection_source_invariant_method=$thull,
                   intersection_method=$thull,
...
validation[case] = Int(property)
SUITE[model][case] = @benchmarkable solve($prob_GRBX02, max_jumps=100,
                   clustering_method=LazyClustering(1, convex=false),
                   intersect_source_invariant=true,
                   intersection_source_invariant_method=$thull,
                   intersection_method=$thull,
...
Plots.plot!(fig, sol_GRBX01, vars=(3, 4), ε=1e-5,
           ...
           size=(1000, 1000))
savefig(fig, joinpath(TARGET_FOLDER, "ARCH-COMP24-JuliaReach-$model-GRBX01.png"))
